...
function ProductList() {
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        // setShowPlants(true); // If you plan to use it later
            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((productList, index) => (
                        <div key={index}>
                            <h2 style={{ textAlign: 'center', color: '#e74c3c', marginTop: '25px' }}>{productList.category}</h2>
                            <div className="product-list">
                                {productList.plants.map((plant) => (
                                    <div className="product-card" key={plant.name}>
                                        ...
                                        <div className="product-details">
                                            ...
                                            >
                                              Add{cartItems.some((item) => item.name === plant.name) ? "ed" : ""} to Cart
                                            </button>
                                        </div>
                                    </div>
                                ))}
